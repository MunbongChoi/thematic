...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--amp", action=argparse.BooleanOptionalAction, default=True, help="Enable AMP for PyTorch models when CUDA is available.")
    parser.add_argument("--grad-clip", type=float, default=1.0, help="Gradient clipping max norm for PyTorch models. Use 0 to disable.")
    parser.add_argument("--unet-ce-weight", type=float, default=1.0, help="Cross-entropy loss weight for UNet.")
    parser.add_argument("--unet-dice-weight", type=float, default=0.5, help="Foreground Dice loss weight for UNet.")
    parser.add_argument("--unet-scheduler", default="cosine", choices=["none", "cosine"], help="Learning-rate scheduler for UNet.")
